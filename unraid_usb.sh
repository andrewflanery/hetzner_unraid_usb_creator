...
download_unraid() {
    ...
    wget -q --show-progress -O /tmp/unraid.zip https://releases.unraid.net/dl/stable/7.3.2/cce9ffc6d2278430ab0029c5b4d66135fa2e9dd2728fc3365cdffa485ebcd713/unRAIDServer-7.3.2-x86_64.zip
